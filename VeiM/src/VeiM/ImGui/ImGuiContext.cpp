...
namespace VeiM
{
	...
	void ImGuiContext::EnableDocking(Window& window)
	{
		...
		if (!window.GetSpecifications().CustomTitleBar && window.GetTitlebar().GetMenubarCallback())
	...
	void ImGuiContext::RenderDockspace()
	{
		// Dockspace
		ImGuiIO& io = ImGui::GetIO();
		ImGuiStyle& style = ImGui::GetStyle();
		float minWinSizeX = style.WindowMinSize.x;
		style.WindowMinSize.x = 250.0f; // TODO : Make customizable
