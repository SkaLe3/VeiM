...
namespace VeiM::UI
{
	...
	{
		// TODO: Add color for Positive and Negative buttons so it is consistent
	...
	struct CORE_API Theme
	{
		...
		static SharedPtr<Image> GetIcon(const String& name);
	...
	private:
		...
		std::unordered_map<String, SharedPtr<Image>> m_Icons;
	private:
