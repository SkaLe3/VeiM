...
IncludeDir["ImNodeEditor"] = "%{wks.location}/Engine/ThirdParty/ImNodeEditor"
...
IncludeDir["assimp"] = "%{wks.location}/Engine/ThirdParty/assimp/include"
IncludeDir["assimpCfg"] = "%{wks.location}/Engine/ThirdParty/assimp/_config_headers"
IncludeDir["entt"] = "%{wks.location}/Engine/ThirdParty/entt/include"
IncludeDir["CityHash"] = "%{wks.location}/Engine/ThirdParty/CityHash/include"